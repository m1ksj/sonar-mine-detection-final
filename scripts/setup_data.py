...
def setup_data(config, source_zip=None, force=False):
    ...
    from sonar_mine_detection.data.yolo_export import (
        export_yolo26n_cv_folds,
    ...
    n_cv_folds = export_yolo26n_cv_folds(
        splits_dir=config["data"]["splits_dir"],
        output_root=config["paths"]["yolo26n_cv_dir"],
    )
    ...
    print(f"YOLO26n CV datasets exported: {n_cv_folds}")
